...
export function Contact() {
  ...
  return (
    <section id="diagnostico" className="py-24 bg-white" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="flex items-center gap-2 text-gray-500 hover:text-[#FF8C00] transition-colors text-sm"
              >
                <Mail size={16} />
          ...
          >
            {sent ? (
              <div className="bg-[#F5F5F5] rounded-2xl p-12 text-center h-full flex flex-col items-center justify-center">
                ...
                <h3 className="font-display font-bold text-2xl text-[#2D2D2D] mb-2">
                  Mensaje recibido
                </h3>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-[#E0E0E0] rounded-lg px-4 py-2.5 text-sm text-[#2D2D2D] focus:outline-none focus:border-[#FF8C00] transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">
                      ...
                      <label
                        ...
                        className={`flex items-center justify-center text-center px-3 py-2 rounded-lg border text-xs cursor-pointer transition-all ${
                          form.tamano === t.value
                            ...
                            : "border-[#E0E0E0] bg-white text-gray-600 hover:border-[#FF8C00]/50"
                        }`}
                      >
                        <input
                          type="radio"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-[#E0E0E0] rounded-lg px-4 py-3 text-sm text-[#2D2D2D] focus:outline-none focus:border-[#FF8C00] transition-colors resize-none"
                  />
                </div>
